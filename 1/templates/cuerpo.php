                    ...
                    <div class="card">
                        <div class="card-image">
                            <figure class="image is-4by3">
                                <img src="../1/Img/infromatica.png" alt="Informatica" width="128" height="128" >
                            </figure>
                        </div>
                        <div class="card-content">
                            <div class="media">
                                <div class="media-content">
                                    <p class="title is-4"><a href="../1/carreras/informatica.php">Carrera de Informatica</a></p>
                ...
                <div class="column">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="media">
                                <div class="media-content">
                                    <p class="title is-4"><a href="../1/carreras/fisica.php">Carrera de Fisica</a></p>
                ...
                <div class="column">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="media">
                                <div class="media-content">
                                    <p class="title is-4"><a href="../1/carreras/matematica.php"">Carrera de Matematica</a></p>
